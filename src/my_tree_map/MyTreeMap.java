...
public class MyTreeMap<K extends Comparable<K>,V> implements Map<K,V> {
        ...
        public static void main(String[] args) {
            ...
            MyTreeMap.put("ABBA",22);
            MyTreeMap.put("The Beatles",14);
            MyTreeMap.put("AC/DC",42);
            MyTreeMap.put("Rod Stewart",57);
            MyTreeMap.put("KISS",89);
            MyTreeMap.put("Scorpions",12);
            MyTreeMap.print();
            System.out.println("get KISS " + MyTreeMap.get("KISS"));
            System.out.println("remove Scorpions " + MyTreeMap.remove("Scorpions"));
            MyTreeMap.print();
        }
}
